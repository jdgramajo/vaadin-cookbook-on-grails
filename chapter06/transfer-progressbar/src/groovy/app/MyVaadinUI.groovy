...
public class MyVaadinUI extends UI {
    ...
    protected void init(VaadinRequest request) {
        ...
        upload.with {
            addProgressListener(uploadReceiver)
            addFinishedListener(uploadReceiver)
            addStartedListener(uploadReceiver)
        }
    ...
    class UploadReceiver implements Upload.Receiver, Upload.ProgressListener,
        ...
        public OutputStream receiveUpload(String filename, String mimeType) {
            ...
            try {
                File file = new File("/Users/jgramajo/Desktop/${filename}")
        ...
        public void updateProgress(long readBytes, long contentLength) {
            ...
            float newValue = readBytes / contentLength as float
            println newValue
